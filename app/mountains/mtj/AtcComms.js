...
const COMMS = {
  south: [
    ...
    },
    {
      ...
      note: 'From about halfway between Gunnison and Montrose. Strong reception the rest of the way.',
      color: '#0891b2',
      x1: 50,
      x2: 20,
    },
  ...
  north: [
    ...
    },
    {
      ...
      facility: 'Denver Center',
      transmitter: 'Montrose Airport',
      note: 'From about 45 miles out. Strong reception the rest of the way.',
      color: '#0891b2',
      x1: 70,
      x2: 20,
    },
...
function CommsStrip({ route }) {
  ...
  return (
    <svg
      viewBox="0 0 460 36"
      role="img"
      aria-label={`Frequency handoff points along the ${route} route, aligned with the pass map above, Front Range on the right and Montrose on the left`}
