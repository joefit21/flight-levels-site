// North-up orientation: west (Montrose) is on the left, east (Front Range) is on
...
const SOUTH_POINTS = [
  ...
  { x: 80, y: 96, label: 'GUC', type: 'airport' },
  { x: 20, y: 92, label: 'MONTROSE', type: 'end', anchor: 'start' },
]
...
export default function RouteMap({ route }) {
  ...
  return (
    <svg
      viewBox="0 0 460 140"
      role="img"
      aria-label={`Stylized elevation profile of the ${route} route from the Front Range to Montrose, oriented north-up`}
