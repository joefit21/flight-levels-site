...
const DATA = {
  south: {
    label: 'South · Primary',
    track: ['Front Range', "Kenosha Pass 10,001'", "Trout Creek Pass 9,346'", 'Buena Vista', "Monarch Pass 11,312'", 'Gunnison', 'Montrose (overfly)', 'Cones VOR (ETL)', 'Telluride'],
    cams: [
      ...
      { label: 'Telluride cam', href: 'https://weathercams.faa.gov/map/-108.19151,37.31714,-107.62571,38.05938/airport/TEX/details/weather' },
    ],
    awos: [
      ...
      { label: 'Telluride AWOS', metar: 'KTEX', href: 'https://aviationweather.gov/data/metar/?ids=KTEX&hours=3' },
    ],
    bailouts: [
  ...
  north: {
    ...
    track: ['Front Range', "Rollins 11,676' (or Berthoud 11,315')", 'Kremmling', 'Eagle County (overfly)', "Cottonwood 8,280' (Gypsum)", 'Montrose (overfly)', 'Cones VOR (ETL)', 'Telluride'],
    cams: [
...
export default function RouteToggle() {
  ...
  return (
    <div>
      ...
      <p className="text-xs text-gray-400 mb-4">North up &middot; Front Range (east) on the right, Telluride (west) on the left</p>
