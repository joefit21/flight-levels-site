...
export const metadata = {
  ...
  description:
    'North and south routes into Telluride Regional from the Front Range: which passes to use, which weather cameras and AWOS to check, and precautionary stops along the way.',
  alternates: {
    canonical: '/mountains/tex',
  },
  openGraph: {
    title: 'Telluride Regional (TEX): Mountain Flying Route Guide',
    description:
      'North and south routes into Telluride from the Front Range, with the exact cameras and AWOS to check before you go.',
    ...
    <main className="min-h-screen bg-white text-gray-900">
      ...
      <article className="px-8 py-20 max-w-3xl mx-auto">
        ...
        <div className="mt-4 mb-10">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-[#1e3a5f] mt-2 mb-2 leading-tight">Telluride Regional</h1>
          <div className="font-mono text-2xl font-bold text-[#1d4ed8] mb-2">TEX</div>
          <p className="font-mono text-sm text-gray-500 mb-4">9,078&#39; MSL</p>
        ...
        <RouteProvider>
          <div className="bg-gray-50 border border-gray-100 rounded-2xl p-6 md:p-8 mb-14">
            ...
            <p className="text-gray-600 mb-4">
              Two ways in. Pick one before you leave the ground: both routes cross above 12,500&#39; MSL, so plan your oxygen accordingly. Both also pass near Montrose before continuing on to Telluride.
            </p>
