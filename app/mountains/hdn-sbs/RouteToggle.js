...
const DATA = {
  south: {
    label: 'South · Primary',
    track: ['Front Range', "Rollins Pass 11,676' (or Berthoud 11,315')", 'Granby', 'Kremmling', "Rabbit Ears Pass 9,426'", 'Steamboat Springs'],
    cams: [
      ...
      { label: 'Walton Peak cam', href: 'https://weathercams.faa.gov/map/-106.93166,40.17812,-106.00332,40.53028/cameraSite/91/details/camera' },
      { label: 'Steamboat cam', href: 'https://weathercams.faa.gov/map/-107.30556,40.25133,-106.42666,40.60206/airport/SBS/details/weather' },
    ],
    awos: [
      ...
      { label: 'Walton Peak AWOS', metar: 'KC07', href: 'https://aviationweather.gov/data/metar/?ids=KC07&hours=3' },
      { label: 'Steamboat AWOS', metar: 'KSBS', href: 'https://aviationweather.gov/data/metar/?ids=KSBS&hours=3' },
    ],
    bailouts: [
  ...
  north: {
    ...
    track: ['Front Range', 'Fort Collins (FNL)', 'Poudre Canyon', "Cameron Pass 10,276'", "Rabbit Ears Pass 9,426'", 'Steamboat Springs'],
    cams: [
      { label: 'Walton Peak cam', href: 'https://weathercams.faa.gov/map/-106.93166,40.17812,-106.00332,40.53028/cameraSite/91/details/camera' },
      { label: 'Steamboat cam', href: 'https://weathercams.faa.gov/map/-107.30556,40.25133,-106.42666,40.60206/airport/SBS/details/weather' },
    ],
    awos: [
      { label: 'Fort Collins-Loveland AWOS', metar: 'KFNL', href: 'https://aviationweather.gov/data/metar/?ids=KFNL&hours=3' },
      { label: 'Jackson County AWOS', metar: 'K33V', href: 'https://aviationweather.gov/data/metar/?ids=K33V&hours=3' },
      { label: 'Walton Peak AWOS', metar: 'KC07', href: 'https://aviationweather.gov/data/metar/?ids=KC07&hours=3' },
      { label: 'Steamboat AWOS', metar: 'KSBS', href: 'https://aviationweather.gov/data/metar/?ids=KSBS&hours=3' },
    ],
    bailouts: [
      { label: 'FNL', metar: 'KFNL', href: 'https://aviationweather.gov/data/metar/?ids=KFNL&hours=3' },
      { label: '33V', metar: 'K33V', href: 'https://aviationweather.gov/data/metar/?ids=K33V&hours=3' },
    ],
  },
}
...
export default function RouteToggle() {
  ...
  return (
    <div>
      ...
      <p className="text-xs text-gray-400 mb-4">North up &middot; Front Range (east) on the right, Steamboat (west) on the left</p>
