...
const COMMS = {
  south: [
    ...
    },
    {
      ...
      note: 'About 40 miles north of MTJ, on through Carbondale and up the valley. Stay with them until they ask you to switch to tower.',
      color: '#db2777',
      x1: 75,
      x2: 20,
    },
  ...
  north: [
    ...
    },
    {
      ...
      facility: 'Aspen Approach',
      transmitter: 'Red Table Mountain',
      note: 'After Cottonwood Pass, on through Carbondale and up the valley. Stay with them until they ask you to switch to tower, no further switch needed.',
      color: '#db2777',
      x1: 150,
      x2: 20,
    },
...
function CommsStrip({ route }) {
  ...
  return (
    <svg
      viewBox="0 0 460 36"
      role="img"
      aria-label={`Frequency handoff points along the ${route} route, aligned with the pass map above, Front Range on the right and Aspen on the left`}
