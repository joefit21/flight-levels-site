...
const COMMS = {
  south: [
    ...
    },
    {
      ...
      note: 'Once past Monarch Pass. Strong reception the rest of the way in, no further switch needed.',
      color: '#059669',
      x1: 155,
      x2: 80,
    },
  ...
  north: [
    ...
    },
    {
      ...
      facility: 'Denver Center',
      transmitter: 'Gunnison Airport',
      note: 'About 20 miles east of MTJ, continuing on to Gunnison. Strong reception the rest of the way.',
      color: '#059669',
      x1: 20,
      x2: 80,
    },
...
function CommsStrip({ route }) {
  ...
  return (
    <svg
      viewBox="0 0 460 36"
      role="img"
      aria-label={`Frequency handoff points along the ${route} route, aligned with the pass map above, Front Range on the right and Gunnison on the left`}
