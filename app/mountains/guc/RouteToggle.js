...
const DATA = {
  south: {
    label: 'South · Primary',
    track: ['Front Range', "Kenosha Pass 10,001'", "Trout Creek Pass 9,346'", 'Buena Vista', "Monarch Pass 11,312'", 'Gunnison'],
    cams: [
  ...
  north: {
    ...
    track: ['Front Range', "Rollins 11,676' (or Berthoud 11,315')", 'Kremmling', 'Eagle County (overfly)', "Cottonwood 8,280' (Gypsum)", 'Montrose (overfly)', 'Gunnison'],
    cams: [
...
export default function RouteToggle() {
  ...
  return (
    <div>
      ...
      <p className="text-xs text-gray-400 mb-4">North up &middot; Front Range (east) on the right, Gunnison (west) on the left</p>
