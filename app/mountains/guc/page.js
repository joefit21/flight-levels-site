...
export const metadata = {
  ...
  description:
    'North and south routes into Gunnison-Crested Butte Regional from the Front Range: which passes to use, which weather cameras and AWOS to check, and precautionary stops along the way.',
  alternates: {
    canonical: '/mountains/guc',
  },
  openGraph: {
    title: 'Gunnison-Crested Butte (GUC): Mountain Flying Route Guide',
    description:
      'North and south routes into Gunnison-Crested Butte from the Front Range, with the exact cameras and AWOS to check before you go.',
    ...
    <main className="min-h-screen bg-white text-gray-900">
      ...
      <article className="px-8 py-20 max-w-3xl mx-auto">
        ...
        <div className="mt-4 mb-10">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-[#1e3a5f] mt-2 mb-2 leading-tight">Gunnison-Crested Butte</h1>
          <div className="font-mono text-2xl font-bold text-[#1d4ed8] mb-2">GUC</div>
          <p className="font-mono text-sm text-gray-500 mb-4">7,680&#39; MSL</p>
